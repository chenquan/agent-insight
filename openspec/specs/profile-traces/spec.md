...
Extract and display single-sample call chains (traces) from a pprof profile, complementary to the `flame` command's folded-stack view. Supports filtering by pprof labels for AI-assisted inspection of specific execution paths.
