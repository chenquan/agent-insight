---
name: agent-insight
description: "使用 agent-insight 分析 Go 性能 profile 文件。TRIGGER 当: 用户提到 pprof、性能分析、CPU profiling、内存泄漏、heap 分析、性能热点、火焰图、.pb.gz 文件、goroutine 泄漏、延迟分析、或想对比 profile 性能差异。"
---
